...
pair_coeff     *     10           0       1       0       0      1
pair_coeff     *     11           0       1       0       0      1
# intra potential for the ghost molecule
pair_coeff     10     10         8520.12       3.7880701       105.29066      0.22908503      0.60800239    # buck6d->(c2_o2@co2m)|co2m/gaussian->(c2_o2@co2m)|co2m <--> buck6d->(c2_o2@co2m)|co2m/gaussian->(c2_o2@co2m)|co2m
pair_coeff     10     11       14587.662        3.618556       237.26086      0.43486526      0.61987656    # buck6d->(c2_o2@co2m)|co2m/gaussian->(c2_o2@co2m)|co2m <--> buck6d->(o1_c1@co2m)|co2m/gaussian->(o1_c1@co2m)|co2m
pair_coeff     11     11        24976.16       3.4635633       528.24945      0.80264773      0.63247476    # buck6d->(o1_c1@co2m)|co2m/gaussian->(o1_c1@co2m)|co2m <--> buck6d->(o1_c1@co2m)|co2m/gaussian->(o1_c1@co2m)|co2m
