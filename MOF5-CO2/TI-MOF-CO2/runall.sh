...
sed -e "s/WWWWW/$a/"  mof5_co2.in > l-$a/mof5_co2.in
sed -e "s/HHHHH/$b/" mof5_co2_nointer.in > l-$a/mof5_co2_nointer.in
sed -e "s/HHHHH/$b/" mof5_co2_electro.in > l-$a/mof5_co2_electro.in
